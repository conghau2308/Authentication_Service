...
import com.Authentication.AuthService.util.TokenHasher;
...
public class RefreshTokenService {
    ...
    public void saveRefreshTokenToRedis(String refreshToken, RefreshTokenData tokenData) {
        String refreshTokenHash = tokenHasher.hash(refreshToken);
            ...
            long ttl = cookieConfig.getRefreshTokenMaxAge() + 60 * 5; // Thêm 5 phút đề phòng trường hợp đồng bộ thời
                                                                      // gian
    ...
    public RefreshTokenData getRefreshTokenDataFromRedis(String refreshToken) {
        ...
        if (obj == null) {
            throw new BusinessException("REFRESH_TOKEN_NOT_FOUND", "Refresh token không tồn tại trong hệ thống.",
